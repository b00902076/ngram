...
```
$ cd .\source
$ g++ .\load_csv.cpp .\build_index.cpp .\main.cpp .\load_record.cpp .\load_index.cpp .\search.cpp .\components\utils\utils.cpp .\components\reader\reader.cpp .\components\writter\writter.cpp -o ngram.exe -std=c++17 -Wall
